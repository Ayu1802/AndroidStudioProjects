...
import com.example.ayushib.tictactoe.StartActivity;
...
//                    .setValue(null);
            ...
            Intent resultIntent = new Intent(this, TicTacToeActivity.class)
                    .putExtra("type", "wifi")
                    .putExtra("withId", fromId)
                    .putExtra("to", fromPushId);
            ...
            startActivity(new Intent(getBaseContext(), TicTacToeActivity.class)
                    .putExtra("type", "wifi")
                    .putExtra("me", "x")
