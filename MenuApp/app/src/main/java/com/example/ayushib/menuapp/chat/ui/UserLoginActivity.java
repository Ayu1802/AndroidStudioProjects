package com.example.ayushib.menuapp.chat.ui;
...
import com.example.ayushib.menuapp.chat.MainChatActivity;

import com.example.ayushib.menuapp.chat.data.SharedPreferenceHelper;
import com.example.ayushib.menuapp.chat.data.StaticConfig;
import com.example.ayushib.menuapp.chat.model.User;
...
public class UserLoginActivity extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if (firstTimeAccess) {
                        startActivity(new Intent(UserLoginActivity.this, MainChatActivity.class));
    ...
    public void clickRegisterLayout(View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            startActivityForResult(new Intent(this, UserRegisterActivity.class), StaticConfig.REQUEST_CODE_REGISTER, options.toBundle());
        } else {
            startActivityForResult(new Intent(this, UserRegisterActivity.class), StaticConfig.REQUEST_CODE_REGISTER);
        }
    }
                    ...
                    .addOnCompleteListener(UserLoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                new LovelyInfoDialog(UserLoginActivity.this) {
                                    @Override
                                ...
                                initNewUserInfo();
                                Toast.makeText(UserLoginActivity.this, "Register and Login success", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(UserLoginActivity.this, MainChatActivity.class));
                                UserLoginActivity.this.finish();
                            }
                        }
        ...
        void saveUserInfo() {
            FirebaseDatabase.getInstance().getReference().child("user/" + StaticConfig.UID).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    SharedPreferenceHelper.getInstance(UserLoginActivity.this).saveUserInfo(userInfo);
                }
