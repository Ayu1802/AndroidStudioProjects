...
public class HangmanPlaceActivity extends AppCompatActivity {
    ...
    private void playGame() {
        ...
        String newWord = places[rand.nextInt(places.length)];

        //we make sure we don't pick the same word two times in a row.
        while (newWord.equals(currWord))  {
            newWord = places[rand.nextInt(places.length)];
        }
        currWord = newWord;
                ...
                winBuild.setPositiveButton("Play Again",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                HangmanPlaceActivity.this.playGame();
                            }});

                winBuild.setNegativeButton("Exit",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                HangmanPlaceActivity.this.finish();
                            }});
