...
import com.example.ayushib.reminderalarm.firebase.RemoveListener;
import com.example.ayushib.reminderalarm.notifier.Scheduler;
...
public class ListItem extends com.example.ayushib.reminderalarm.firebase.ListItem{
    ...
    public Integer getNotificationId(boolean existingOnly) {
        ...
        if (notificationId == 0)
            notificationId = com.example.ayushib.reminderalarm.notifier.Notification.getId();
        return notificationId;
    }
